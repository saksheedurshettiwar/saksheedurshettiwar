        ...
        <AnimatedSection delay={0.6}>
          <div className="mt-16">
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
              ...
              {/* Card 4 - Products */}
              <motion.div 
                className="bg-gradient-to-br from-amber-50 to-orange-50 border border-amber-100 rounded-2xl p-6 h-[350px] flex flex-col justify-between"
              ...
              {/* Card 5 - Photo */}
              <motion.div 
                className="rounded-2xl h-[350px] overflow-hidden"
              ...
              {/* Card 6 - Writing */}
              <motion.div 
                className="bg-gradient-to-br from-pink-50 to-rose-50 border border-pink-100 rounded-2xl p-6 h-[350px] flex flex-col justify-between"
